...
class SuratTugasPolicy
{
    ...
    {
        return $user->can('force_delete_surat::tugas');
    }
    ...
    {
        return $user->can('force_delete_any_surat::tugas');
    }
    ...
    {
        return $user->can('replicate_surat::tugas');
    }
    ...
    {
        return $user->can('reorder_surat::tugas');
    }
}
